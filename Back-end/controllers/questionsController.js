//Questions.js using mongo db

const Questions=require('../models/question.js')

const getAllApprovedQuestions=async(req,res)=>{
    try{
...
const getAllApprovedQuestionsOfUser=async(req,res)=>{
    try{
...
const getAllUnApprovedQuestions=async(req,res)=>{
    try{
...
const getQuestionByText=async(req,res)=>{
    try{
...
module.exports={getAllQuestions,getQuestionById,getQuestionByCategory,
    deleteQuestionById,createQuestion,getQuestionByText,getAllQuestionsByUser,updateQuestion,
    getAllApprovedQuestions,approveQuestion,resolveQuestion,getAllUnApprovedQuestions,getAllApprovedQuestionsOfUser};